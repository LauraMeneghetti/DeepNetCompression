...
def save_checkpoint_objdet(epoch, model, optimizer, filename):
    '''
    ...
    :param str filename: name of the checkpoint file
    ...
    for c in range(1, n_classes):
        ...
        for d in range(n_class_detections):
            ...
            original_ind = torch.LongTensor(range(
                true_class_boxes.size(0))).to(device)
            original_ind = original_ind[true_class_images == this_image][ind]
