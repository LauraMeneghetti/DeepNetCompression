...
from models.fnn import FNN, training_fnn
...
class NetAdapter():
    ...
    def reduce_net(self, input_network, train_dataset, train_labels,
        ...
        # if the project matrices have been computed previusly, they can be loaded using torch.load
        # without requiring the previous computation
        if self.inout_method == 'PCE':
